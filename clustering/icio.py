...
def read_images(imagedir, size, ncores=mp.cpu_count()):
    ...
    return {k: v for k,v in ret if v is not None} # filename, arr
...
def get_image_data(imagedir, model_kwds=dict(layer='fc2'),
    ...
    # 이미 fingerprint 파일이 존재하면 읽어옴/아니면 생성함
